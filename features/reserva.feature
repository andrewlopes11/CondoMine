Feature: Reservar ambiente
  ...
  Scenario: fazer uma nova reserva
    ...
    And preencho a data inicial '2024-03-10',gi data final '2024-04-20', hora inicial '09:00' e hora final '13:00'
  ...
  Scenario: cadastrar uma reserva sem um condomino
    Given estou na pagina de cadastro de reserva
    When preencho com o condomino '', ambiente 'Quadra', data inicial '2024-04-21', data final '2024-04-29', hora inicial '06:00' e hora final '08:00'
    And eu clico no botao 'Create Reserva'
    Then eu vejo a mensagem de erro 'Condomino must exist'

  Scenario: tentar fazer uma reserva sem o ambiente
    Given estou na pagina de cadastro de reserva
    When preencho com o condomino 'Marcos Teste', ambiente '', data inicial '2025-01-01', data final '2024-01-02', hora inicial '10:00' e hora final '16:00'
    And eu clico no botao 'Create Reserva'
  ...
  Scenario: editar uma reserva
    ...
    When eu edito os dados da reserva condomino 'Marcos Teste', ambiente 'Quadra', data inicial '2024-03-10', data final '2024-04-15', hora inicial '09:00' e hora final '13:00'
    And eu clico no botao 'Update Reserva'
    Then eu vejo a mensagem de sucesso 'Reserva was successfully updated'

  Scenario: apagar um reserva
    Given estou na pagina de cadastro de reserva
    When eu clico no botao 'Apagar esta reserva' apagando a reserva
