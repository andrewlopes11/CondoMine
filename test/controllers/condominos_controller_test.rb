...
class CondominosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condomino" do
    assert_difference("Condomino.count") do
      post condominos_url, params: { condomino: { contato: @condomino.contato, cpf: @condomino.cpf, nome: @condomino.nome } }
    end
  ...
  test "should update condomino" do
    patch condomino_url(@condomino), params: { condomino: { contato: @condomino.contato, cpf: @condomino.cpf, nome: @condomino.nome } }
