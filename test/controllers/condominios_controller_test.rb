...
class CondominiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condominio" do
    assert_difference("Condominio.count") do
      post condominios_url, params: { condominio: { cnpj: @condominio.cnpj, nome: @condominio.nome } }
    end
  ...
  test "should update condominio" do
    patch condominio_url(@condominio), params: { condominio: { cnpj: @condominio.cnpj, nome: @condominio.nome } }
